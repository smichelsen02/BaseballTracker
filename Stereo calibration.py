...
#chess board size here, number of corners horizonatally and vertically
chessboardSize = (8,5)
#frame size in pixels of images generated for calibration
frameSize = (1024,1024)
...
for imgLeft, imgRight in zip(imagesLeft, imagesRight):
    ...
    #this function only accepts grayscale images
